---
title: "mfg_requirements"
type: "concept"
topics: [aerospace, manufacturing, compliance, quality-standards, regulations]
sources: []
status: "active"
---
...
This document outlines the dominant quality process standards and regulatory requirements governing production in the Canadian aerospace manufacturing industry. These requirements form the expository audit baseline that [[wiki/pages/concepts/dual_register_playbook|Dual-Register Playbooks]] must satisfy.

## 1. Federal Regulatory Standards (Transport Canada)
...
## 2. Global Aerospace Quality Management Standards (AS9100 Series)

While Transport Canada oversees legal safety and airworthiness, global aerospace Original Equipment Manufacturers (OEMs) (e.g., Bombardier, Pratt & Whitney Canada, Boeing, Airbus) mandate certification to the **AS9100** series as a prerequisite to join their supply chains:
...
## 3. Specialized Process Accreditation (Nadcap)

For manufacturing processes where final quality cannot be easily verified by non-destructive testing after production (known as **special processes**), the industry uses the **Nadcap** (National Aerospace and Defense Contractors Accreditation Program) standard:
...
## 4. Security & Export Control (Controlled Goods Program - CGP)

Although not a quality standard in the traditional sense, the **Controlled Goods Program (CGP)** is a critical security and compliance requirement for aerospace production in Canada:
...
## 5. Bicultural Integration Alignment

These strict quality standards form the "expository audit baseline" for aerospace manufacturing. To bridge the cognitive gap and maintain shop-floor compliance without alienating workers, local initiatives implement [[wiki/pages/concepts/dual_register_playbook|Dual-Register Playbooks]] where:
